...
import static FisioTracker.Android.OrtoTracker_Services.service_04_Bluetooth.initializeBluetoothAdapter;
import static FisioTracker.Android.OrtoTracker_Services.service_04_Bluetooth.requestBluetoothPermissions;
...
import FisioTracker.Android.OrtoTracker_Dialogs.Dialog_03_BLE_Devices;
import FisioTracker.Android.OrtoTracker_Dialogs.Dialog_05_Session_Options;
import FisioTracker.Android.OrtoTracker_Dialogs.Dialog_02_ConfirmAction;
import FisioTracker.Android.OrtoTracker_Dialogs.Dialog_04_Pacient_Form;
import FisioTracker.Android.OrtoTracker_Graphs.graph_01_speedometer;
import FisioTracker.Android.OrtoTracker_Services.service_04_Bluetooth;
...
public class activity_02_dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopButton.setOnClickListener(v -> {
            Dialog_02_ConfirmAction.showConfirmDialog(this);
            disableSimultaneousPacientVisibility();
        });
            ...
            initializeBluetoothAdapter(this, new service_04_Bluetooth.BluetoothAdapterCallback() {
                ...
                public void onBluetoothNotEnabled(BluetoothAdapter adapter) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        if (ActivityCompat.checkSelfPermission(activity_02_dashboard.this, Manifest.permission.BLUETOOTH_CONNECT)
        ...
        newSession.setOnClickListener(v -> {
            Dialog_05_Session_Options.showDialog_03(this);
        });
        ...
        coresSelecionadas.put(R.id.button_pacient_1, getColor(R.color.DarkPastelgreen));
        coresSelecionadas.put(R.id.button_pacient_2, getColor(R.color.Azure));
        coresSelecionadas.put(R.id.button_pacient_3, getColor(R.color.Topaz));
    ...
    public void enableSimultaneousPacientVisibility() {
        ...
        add_Pacient.setBackgroundResource(R.drawable.bg_inactive_gradient);
    ...
    public void disableSimultaneousPacientVisibility() {
        BlurView pacienteSimultaneo = findViewById(R.id.glass2);

...
import FisioTracker.Android.OrtoTracker_Model.Services.service_01_cache_loader;
...
public class activity_00_splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service_01_cache_loader.preload(this, R.raw.lottie_01_button_animated_gradient);

...
public class Dialog_06_Select_Pacient implements Dialog_00_Interface {
    ...
    public void showDialog(Context context) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_06_pacient_list, null);
        ...
        dialogView.findViewById(R.id.close_button).setOnClickListener(v -> {
            if (context instanceof activity_02_dashboard) {
                ((activity_02_dashboard) context).enableSimultaneousPacientVisibility();
            }
            dialog.dismiss();

...
public class graph_02_dispersal extends View {
    ...
    private float gradientTop = 0f;
    private float gradientBottom = 0f;
    ...
    private void init(AttributeSet attrs) {
        ...
        dashedLinePaint.setStrokeWidth(0.5f);
    ...
    public void setChartColors(@ColorInt int lineColor, @ColorInt int fillColor, @ColorInt int pointColor) {
        ...
        if (gradientBottom > gradientTop) {
            ...
            int semiTransparentFill = (0x88 << 24) | (fillColor & 0x00FFFFFF);

...
public class PacientGraphView extends View {

    public PacientGraphView(Context context) {
        super(context);
        init(null);
    }

    public PacientGraphView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public PacientGraphView(Context context, AttributeSet attrs, int defStyleAttr) {

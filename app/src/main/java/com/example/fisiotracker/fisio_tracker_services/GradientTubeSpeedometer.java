...
public class GradientTubeSpeedometer extends TubeSpeedometer {

    private Paint backgroundPaint;
    private Paint gradientPaint;
    private RectF arcRect;

    public GradientTubeSpeedometer(Context context) {
        super(context);
        init();
    }

    public GradientTubeSpeedometer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GradientTubeSpeedometer(Context context, AttributeSet attrs, int defStyleAttr) {

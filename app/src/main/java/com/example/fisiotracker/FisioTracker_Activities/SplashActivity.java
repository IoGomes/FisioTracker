...
import com.example.fisiotracker.FisioTracker_Activities.AuthenticationScreenActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationView.addAnimatorListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                Intent intent = new Intent(SplashActivity.this, AuthenticationScreenActivity.class);
